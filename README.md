...
* 하고 싶은 일을 하는 것보다 하기 싫은 일을 안하는 것을 더 중요하게 여긴다.

## 네모리움:

* 옥수박이 메모, 보고서, 잡글을 적고 [개인 프로젝트][link-projects]를 진행하는 [개인 블로그][link-archives]이다.
* 블로그의 운영 목적은 생각과 자료들을 정리해서 부족한 기억력을 보조하는 것이다.
* 소통은 주된 관심사가 아니므로 댓글에 대한 응답이 느리거나 없을 수 있다.
* 광고, 중복, 사생활 침해에 해당하는 댓글은 통보 없이 삭제될 수 있다.
* 주요 업데이트 주제는 다음과 같다:
    * 일상 기록: [#독서](/독서-목록) [#게임](/게임-목록) [#감상](/감상-목록)
    * 기술 공부: [#리소스](/개발-리소스-링크-모음) [#블렌더](/블렌더-공부) [#에이스프라이트](/에이스프라이트-공부) [#C#](/C-Sharp-공부) [#비주얼_스튜디오](/비주얼-스튜디오-공부) [#라이더](/라이더-공부) [#유니티_엔진](/유니티-엔진-공부) [#고도_엔진](/고도-엔진-공부)
    * 관리 기록: [#윈도우](/윈도우-기기-관리) [#리눅스](/리눅스-기기-관리) [#애플](/애플-기기-관리) [#안드로이드](/안드로이드-기기-관리) [#구글](/구글-서비스-관리) [#아케이드_캐비닛](/아케이드-캐비닛-관리)

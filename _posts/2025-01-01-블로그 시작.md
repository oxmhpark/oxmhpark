...
---
> 인용문구 테스트 인용문구 테스트 인용문구 테스트 인용문구 테스트 인용문구 테스트 인용문구 테스트 인용문구 테스트 인용문구 테스트 인용문구 테스트 인용문구 테스트 인용문구 테스트 인용문구 테스트 인용문구 테스트 인용문구 테스트 인용문구 테스트 
...
- 이미 작성한 포스트를 갱신하려는 경우에는 본문 하단에 맥락과 이력을 밝힌다.
...
- [x] 본문 하단에 소속 게시물 목록을 출력할 것.[※4][link-repo-file-category]
- 주의) 포괄적인 카테고리를 피할 것; 되도록 단기적이고 구체적인 목표를 세우자.

### 반복해서 다룰 가능성이 있는 소재는 태그로 규정한다[※5][link-repo-folder-tags]
- [x] 본문 하단에 소속 게시물 목록을 출력할 것.[※6][link-repo-file-tag]
- 주의) `#장소`와 같은 일반명사를 피하고 `#합정역`과 같은 고유명사로 범위를 좁힐 것.

### 한 해를 계획하거나 정리하는 페이지는 연간 아카이브로 활용한다[※7][link-repo-folder-years]
- [x] 본문 하단에 소속 게시물 목록을 출력할 것.[※8][link-repo-file-year]

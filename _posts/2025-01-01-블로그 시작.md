...
- 페이지
  - [즐겨찾기][link-blog-page-bookmarks]나 [소개][link-blog-page-readme]처럼 내용과 형식을 활용하는 것이 목적인 게시물은 페이지로 규정하고 `_pages` 폴더 하위에 작성한다.[※2][link-repo-folder-pages]
...
[link-blog-page-readme]: https://nemorium.net/readme

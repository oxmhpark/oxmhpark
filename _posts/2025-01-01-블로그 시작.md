...
본문 하단에 소속 게시물 목록을 출력할 것.[※4][link-repo-file-category]

**반복해서 다룰 가능성이 있는 소재는 태그로 규정한다.**[※5][link-repo-folder-tags]\
본문 하단에 소속 게시물 목록을 출력할 것.[※6][link-repo-file-tag]

**한 해를 계획하거나 정리하는 게시물은 연간 아카이브로 규정한다.**[※7][link-repo-folder-years]\
본문 하단에 소속 게시물 목록을 출력할 것.[※8][link-repo-file-year]

**첨부 파일은 미리 정해둔 폴더에, 계층구조 없이 저장한다.**[※9][link-repo-folder-attachments]\
...
[link-repo-folder-attachments]: https://github.com/oxmhpark/oxmhpark/tree/main/_assets/attachments/
